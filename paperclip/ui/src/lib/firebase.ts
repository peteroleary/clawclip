...
// Check if valid API key is present before initializing Firebase Auth to prevent screen blanking crashes
const hasValidConfig = Boolean(firebaseConfig.apiKey && firebaseConfig.apiKey.length > 5);
