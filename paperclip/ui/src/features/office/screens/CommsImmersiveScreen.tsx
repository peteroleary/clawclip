...
import { MessageSquare, Send, User, Bot, Hash, Kanban, Sparkles } from "lucide-react";
...
export const CommsImmersiveScreen: React.FC<CommsImmersiveScreenProps> = ({
  ...
  return (
    <ImmersiveScreenWrapper
      isOpen={isOpen}
      onClose={onClose}
      title="Comms & Live Chat HQ"
      subtitle="Interlinked entity group chats for Companies, Departments, Projects, and Teams"
      icon={MessageSquare}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-64 border-r border-slate-800 bg-[#06090d]/60 p-4 space-y-4 shrink-0 overflow-y-auto">
          ...
          <div>
            ...
            <div className="space-y-1">
              {[
                { id: "proj-clawclip", label: "#proj-clawclip" },
          ...
          <div>
            <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Team Channels</h4>
            <div className="space-y-1">
              {[
                { id: "team-core-squad", label: "#team-core-squad" },
              ].map((ch) => (
                <button
                  key={ch.id}
                  onClick={() => setActiveChannel(ch.id)}
          ...
          <div>
            <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Direct Messages</h4>
            <div className="space-y-1">
              {[
