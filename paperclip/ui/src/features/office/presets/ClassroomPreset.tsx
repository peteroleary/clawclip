...
interface ClassroomPresetProps {
  onDeskClick?: (deskId: string) => void;
}

export const ClassroomPreset: React.FC<ClassroomPresetProps> = ({ onDeskClick }) => {
  ...
  return (
    <group>
      {/* Classroom Tile Floor (Original 24x20 dimensions) */}
      ...
      {/* Classroom Walls (Original positions) */}
      {/* Back Wall */}
