...
import { humanEmployeesRouter } from "./routes/human_employees.js";
import { workforceRouter } from "./routes/workforce.js";
import { virtualWorkspacesRouter } from "./routes/virtual_workspaces.js";
...
export async function createApp(
  ...
  api.use("/companies/:companyId/human-employees", humanEmployeesRouter(db));
  api.use("/companies/:companyId/workforce", workforceRouter(db));
  api.use("/companies/:companyId/virtual-workspaces", virtualWorkspacesRouter(db));
